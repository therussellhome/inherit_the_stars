...
class Race(Defaults):
    ...
    def _calc_points_research(self):
        ...
        # Research modifiers
        researchmodifiers = [self.research_modifier_energy, self.research_modifier_weapons, self.research_modifier_propulsion, self.research_modifier_construction, self.research_modifier_electronics, self.research_modifier_biotechnology]
    ...
    def _calc_points_economy(self):
        ...
        ap -= (1200 - self.cost_of_baryogenesis) * economy_cost['baryogenesis_invert_slope']

...
class NewGameTestCase(unittest.TestCase):
    ...
    def test_generate_home_systems(self):
        ng = new_game.NewGame()
        s0 = star_system.StarSystem(name='antheu 0')
        s1 = star_system.StarSystem(name='antheu 1')
        s2 = star_system.StarSystem(name='antheu 2')
        s3 = star_system.StarSystem(name='antheu 3')
        s4 = star_system.StarSystem(name='antheu 4')
        s5 = star_system.StarSystem(name='antheu 5', location=location.Location(x=100, y=50, z=100))
        s6 = star_system.StarSystem(name='rc,g 0', x=-100, y=-50, z=-100)
